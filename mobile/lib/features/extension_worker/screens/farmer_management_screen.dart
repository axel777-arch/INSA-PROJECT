...
class _FarmerManagementScreenState extends State<FarmerManagementScreen> {
  ...
  static const List<String> _cropOptions = ['All', 'wheat', 'maize', 'soybeans', 'teff', 'barley'];
  static const List<String> _regionOptions = ['All', 'Oromia', 'Amhara', 'SNNPR', 'Tigray'];
                  ...
                  : _farmers.isEmpty
                      ? Center(
                          child: Column(
                            ...
                            children: [
                              Icon(Icons.person_search_rounded, size: 48, color: theme.disabledColor),
                              const SizedBox(height: AppSizes.p12),
                              const Text('No farmers match your search or filters.'),
                            ],
                          ),
                        )
                      : ListView.builder(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            farmer.fullName.isEmpty ? 'Unnamed farmer' : farmer.fullName,
                                    ...
                                    Text('Crops: ${farmer.cropIds.isEmpty ? '—' : farmer.cropIds.join(', ')}'),
                                    Text('Location: ${farmer.region}, ${farmer.woreda}'),
                                          ...
                                          child: AppButton(
                                            ...
                                            onPressed: () {
                                              ScaffoldMessenger.of(context).showSnackBar(
                                                SnackBar(content: Text('Editing ${farmer.fullName} is not available in this mock build yet.')),
                                              );
                                            },
                                          ),
                                        ),
    ...
    return SafeArea(
      child: Padding(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(farmer.fullName, style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
